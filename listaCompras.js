...
function somaLista() {
     ...
     * para verificar e setar 
     * valores na array
     */
    for (let index = 0; index < tdValue.length; index++) {
        /** setando texto da td dentro
         * do array values usando como referencia
         * o index
         */
        values[index] =
        parseFloat(tdValue[index].textContent);
        /** Somando valor da variável 
         * valorTotal com o valor da td
         */
        valorTotal += 
